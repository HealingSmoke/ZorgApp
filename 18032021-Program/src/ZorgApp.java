...
public class ZorgApp
{
   ...
   public ZorgApp()
   {
      ...
      profile = new Profile('p', "p1", "4567", "Amanda", "Schoonhoven", 29, 51.4, 1.68, 21, medicineList);
      profileList.addProfile(profile);
      profile = new Profile('p', "p2", "7899", "Anna", "Moonlight", 44, 68.4, 1.72, 24, medicineList);
      profileList.addProfile(profile);
      profile = new Profile('p', "p3", "1123", "Bernard", "Houten", 58, 85.8, 1.78, 21, medicineList);
      profileList.addProfile(profile);
      profile = new Profile('p', "p4", "2254", "Chris", "Penrose", 32, 68.4, 1.72, 28, medicineList);
      profileList.addProfile(profile);
      profile = new Profile('p', "p5", "4545", "Niels", "Schoonhoven", 33, 82.4, 1.85, 25, medicineList);
      profileList.addProfile(profile);
      profile = new Profile('p', "p6", "8445", "Rick", "Schuiten", 24, 78.4, 1.72, 28, medicineList);
      profileList.addProfile(profile);
   ...
   //Patient gedeelte
   public boolean PatientMenu(Profile patient)
   {
      do
      {
   ...
   */ //Patient toevoegen
   ...
   {
      Profile patient = new Profile('p', "", "", "", "", 0, 0, 0, 0, medicineList);
      patient.EditPatientAlles();
