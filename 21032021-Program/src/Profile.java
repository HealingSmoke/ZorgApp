...
public class Profile
{
   ...
   public void PrintProfileMedicine(Profile profile)
   {
   ...
   public void EditProfileAlles(Profile profile) //Patient zelf profiel bewerken
   {
      boolean exit = false;
      while (!exit)
      {
      ...
      System.out.print("Wat is uw voornaam: ");
      ...
      setLengte(parseDouble(string.nextLine()));
      System.out.print("Wat is uw gewicht: ");
      setGewicht(parseDouble(string.nextLine()));
      ReCalcBMI();
   ...
   public void EditPatientAlles(Profile patient) //Zorgverlener die patient profiel bewerkt
   {
      setVerificatie('p');
